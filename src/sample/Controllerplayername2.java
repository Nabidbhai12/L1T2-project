...
public class Controllerplayername2 implements Initializable {
    ...
    void keypressed(KeyEvent event) {
        System.out.println( "testing donee");
    ...
    void Searchbtn(ActionEvent event) {
        ...
        String nas=null,str1=null;
        str1=main.getClientName();
        nas=playercountry.getText();
